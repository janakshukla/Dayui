...
const Navbar = () => {
  return (
    <nav className="w-11/12 mx-auto text-[#b2b2b2] flex items-center border  justify-between p-2 mt-2 rounded-4xl">
        ...
        <button className='flex items-center gap-1 border border-white px-2 py-0.5 rounded-2xl text-xs '>SIGN UP <ArrowRightCircleIcon fill='#FFFFFF' color='#000000' /> </button>
