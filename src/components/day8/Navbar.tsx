...
const Navbar = () => {
  return (
   <div>
     <nav className="w-11/12  mx-auto text-[#b2b2b2] flex items-center border  justify-between p-2  rounded-4xl">
        <div className='flex items-center justify-around gap-2 w-1/3' >
            <SquareUserRound size={32} fill='#2B4491' />
            <p className='uppercase text-nowrap font-medium text-xs ' >about <br /> us</p>
