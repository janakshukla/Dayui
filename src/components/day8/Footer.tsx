...
const Footer = () => {
  return (
    <div className="px-4 flex flex-col sm:flex-row gap-4 sm:gap-1 mt-4">
      <Card className="sm:w-1/5 h-44 bg-[#39D8EE] flex p-4 flex-col items-center justify-between gap-6 ">
      ...
      <Card className="sm:w-1/5 h-44 bg-[#E1E1E1] flex p-4 flex-col items-center justify-between gap-6 ">
        <CardHeader className="flex justify-between ">
      ...
      <Card className="sm:w-1/5 h-44 bg-[#FDC959] flex p-4 flex-col items-center justify-between gap-6 ">
        <CardHeader className="flex justify-between ">
        ...
        <CardFooter className="text-black/90  tracking-tighter leading-tight text-2xl  font-inter" >OUR CASE <br /> STUDIES</CardFooter>
      </Card>
      <div className="sm:w-1/5 h-44 flex flex-col gap-1 justify-end p-4 " >
      ...
      <div className="sm:w-1/5 h-44 flex   gap-2 p-4 mt-6 " >
      <Play fill="black" className="size-8 rounded-full p-2 bg-white/70 text-black" />
      <h1 className="text-xs text-nowrap  text-white/70 " >Let's See <br /> How We Did it. </h1>
