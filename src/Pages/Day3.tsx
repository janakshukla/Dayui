...
const Day3 = () => {
  return (
    <div className="h-screen w-screen scale-75 sm:scale-100  flex justify-center items-center bg-white ">
      <div className="h-64  rounded-[52px] bg-[#A1F452] shadow-[inset_0px_-2px_4px_0_#74D816]/51 drop-shadow-[inset_0px_14px_12px_0_#A1F452]/13 ">
